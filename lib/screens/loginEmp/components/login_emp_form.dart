...
import 'package:haircut_app/models/employee.dart';
...
class LoginEmpForm extends StatefulWidget {
  @override
  _LoginEmpFormState createState() => _LoginEmpFormState();
}

class _LoginEmpFormState extends State<LoginEmpForm> {
  ...
  Future _submit() async {
    ...
    final url = Uri.parse('${Api.url}/empLogin');
    ...
    if (response.statusCode == 200) {
      ...
      prefs.setString("token", empData.token!);
